<!-- Generated from wiki/Order-routes-and-norms.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Контекст здесь — самостоятельный набор назначений для подбора, а не другое название пакета изменения. Подробности — [контексты выбора](Selection-contexts.md).
...
Это изложено в [справочных таблицах](Reference-tables.md), [многомерных таблицах](Multidimensional-tables.md) и [координатных картах](Coordinate-maps.md). Порядок строк, перевод единиц и перестановка осей на экране не должны менять смысл найденной нормы.
...
Производственные маршруты, контролируемые замены, способы обеспечения и разделение количества входят в целевые требования Interlink. Их сочетания необходимо проверить с владельцами процессов: один участок может изготавливать часть количества, другой — закупать остаток или передавать его в кооперацию. Для каждой доли должны быть определены маршрут, основание выбора и ответственность.
...
- Как предприятие различает изготовление, закупку и кооперацию?
...
8. Смена маршрута объяснимо добавляет и заменяет предусмотренные назначения контекста, не очищая остальные назначения автоматически.
...
- [Производственные ведомости и отчёты](Order-production-documents.md)
- [MRP и внешние системы](Order-integration.md)
