<!-- Generated from wiki/Data-model-lifecycle.md. Edit the source, then run tools/Build-Book.ps1. -->
...
- совпадает ли результат с ожидаемыми приёмочными примерами.
...
Interlink строит развитие структуры данных вокруг проверяемой поставки модели. В целевой системе часто используемые типы материализуются в реальные таблицы, а чтение и изменение используют согласованные прикладные контракты. Изменение модели проверяется не только как преобразование схемы, но и как сохранение смысла данных, прав и обязательных пользовательских сценариев.
...
Связанные документы: [язык модели](Data-model-language.md), [материализация](Data-database-materialization.md), [расширяемость](Data-extensibility.md), [установка и работа системы](Data-model-runtime.md), [миграция существующих данных](Data-migration-strategy.md), [предметно-независимый фундамент](Object-foundation.md), [табличные данные](Tabular-data.md), [действия агентов и прослеживаемость](Agents-and-traceability.md).
