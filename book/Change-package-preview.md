<!-- Generated from wiki/Change-package-preview.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Связанные документы: [жизненный цикл](Change-package-lifecycle.md), [проведение и восстановление](Change-package-commit.md), [снимки и доказательства](Change-package-snapshots.md), [допустимые замены](Allowed-replacements.md), [матрицы совместимости](Compatibility-matrices.md), [агенты и прослеживаемость](Agents-and-traceability.md).
