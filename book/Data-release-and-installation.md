<!-- Generated from wiki/Data-release-and-installation.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Связанные документы: [жизненный цикл модели](Data-model-lifecycle.md), [миграция и доказательство](Data-migration-execution.md), [настройки предприятия](Data-enterprise-settings.md), [состояние и риски](Data-status-risks-acceptance.md), [многомерные таблицы](Multidimensional-tables.md), [действия агентов и прослеживаемость](Agents-and-traceability.md).
