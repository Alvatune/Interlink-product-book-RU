<!-- Generated from wiki/Data-enterprise-settings.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Связанные документы: [расширяемость](Data-extensibility.md), [жизненный цикл модели](Data-model-lifecycle.md), [выпуск и установка](Data-release-and-installation.md), [цифровые двойники](Data-digital-twins.md).
