<!-- Generated from wiki/Order-integration.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Сам файл обмена остаётся формой передачи. [Справочные таблицы](Reference-tables.md) и [координатные карты](Coordinate-maps.md) позволяют искать исходные данные внутри системы, но чтение новой строки не запускает автоматически обновление карточек или внешних заданий. Такая синхронизация оформляется отдельной проверяемой операцией.
...
- [Экземпляры и фактический состав](Order-units-lots-as-built.md)
