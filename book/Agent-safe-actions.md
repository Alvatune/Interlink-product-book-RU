<!-- Generated from wiki/Agent-safe-actions.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Продолжение: [агент и фактический контекст](Agents-and-traceability.md), [пакет изменения](Change-package-guide.md), [допустимые замены](Allowed-replacements.md), [совместимость](Compatibility-matrices.md), [план развития](Current-state-and-roadmap.md).
