<!-- Generated from wiki/Data-model-language.md. Edit the source, then run tools/Build-Book.ps1. -->
...
- [Миграция базы исходной системы](Data-migration-strategy.md)
