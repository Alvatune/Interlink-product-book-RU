<!-- Generated from wiki/Agents-and-traceability.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Историческое чтение проверяет права сегодняшнего проверяющего. Прежнее разрешение агента не открывает проверяющему закрытые сейчас данные. Если обязательное содержимое выбыло по разрешённой политике или утрачено, интерфейс указывает, какие исходные материалы недоступны и какую часть решения из-за этого нельзя воспроизвести. Сохранённый контрольный отпечаток файла помогает проверить известные байты, но не восстанавливает исчезнувший документ.
...
Продолжение: [безопасные действия и восстановление](Agent-safe-actions.md), [производительность при агентской нагрузке](Performance-and-agents.md), [цифровые двойники](Digital-twins.md), [текущее состояние и план](Current-state-and-roadmap.md).
