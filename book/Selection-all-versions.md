<!-- Generated from wiki/Selection-all-versions.md. Edit the source, then run tools/Build-Book.ps1. -->

# Просмотр всех версий объекта

> Описана целевая работа Interlink. Пользовательское представление истории и его проверка на пользовательских сценариях ещё должны быть реализованы; наличие такого описания не означает готового экрана.
...
Для портфельных и аналитических представлений нужен режим «Все версии объектов». Он показывает все доступные пользователю версии, но не подменяет обычное формирование состава, где для конкретного места требуется однозначный выбор.
...
Отдельно сохраняется потребность предприятия в **вариантном плановом заказе**: на стадии планирования он может содержать разрешённые заменители и ещё не выбранные маршруты. Это не режим «показать все версии каждой детали» и не готовая однозначная передача в производство.
...
## Как отделены обзор и подбор

| Аспект | Требование сценария | Решение Interlink |
|---|---|---|
...
- Какие столбцы исторического представления наиболее важны специалистам предприятий?
...
- [Основная версия объекта](Selection-main-version.md)
- [Последняя допустимая версия](Selection-latest-version.md)
- [Закрепление версии и точного состояния](Selection-exact-fixation.md)
