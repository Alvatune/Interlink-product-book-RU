<!-- Generated from wiki/Selection-sequential-changes.md. Edit the source, then run tools/Build-Book.ps1. -->

# Последовательное проведение изменений

## Зачем нужен этот режим

Правило «Последовательное проведение изменений» должно находить версии объектов на предусмотренных уровнях продвижения, например «Создание и модификация» или «Согласование и утверждение». Точные уровни и их сопоставление шагам жизненного цикла задаются настройкой процесса.
...
## Почему решение закрывает предметное требование
...
- Какие уровни и условия должно использовать правило последовательного проведения изменений?
...
Разделение работы, контекста, инженерной версии и её состояний принято в целевой архитектуре. Сквозное поведение ещё требует реализации и проверки на согласованных настройках процесса. Согласование и пользовательские формы остаются функцией прикладной системы поверх Interlink; наличие архитектурного договора не означает готового рабочего места.

## Связанные документы

- [Работа, контекст и пакет изменения](Selection-change-package.md)
- [Контексты подбора](Selection-contexts.md)
- [Подбор по степени готовности](Selection-maturity.md)
- [Настраиваемое правило](Selection-custom-rule.md)
