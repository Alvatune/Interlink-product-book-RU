<!-- Generated from wiki/Changes-and-evidence.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Это архитектурный план, а не утверждение о готовом архиве или интерфейсе. Полный эксплуатационный путь описан в [путеводителе по пакету изменения](Change-package-guide.md).
...
Промежуточная итерация также не равна выпуску. Она сохраняет точный рабочий результат, чтобы к нему можно было вернуться. Возврат в рабочую копию не создаёт официального состояния автоматически; последующее проведение требует обычных проверок. См. [итерации и восстановление](Selection-iterations.md).
...
Подробные варианты — в [проведении и восстановлении](Change-package-commit.md) и [истории, снимках и доказательствах](Change-package-snapshots.md).
...
Связанные страницы: [рабочие области](Workspaces-and-parallel-work.md), [предпросмотр и согласование](Change-package-preview.md), [агенты и прослеживаемость](Agents-and-traceability.md), [заказы и производство](Orders-guide.md), [вопросы об объектах и изменениях](Questions-versions-and-changes.md), [вопросы о документах](Questions-documents.md).
