...
Различимые исходы, объяснение, ограничения резерва и отдельное управление заменами входят в целевой порядок работы. Полный исполнитель и рабочие места ещё требуют реализации; конкретные резервные правила согласуются с предприятием и проверяются испытаниями.

## Связанные документы

- [Настраиваемые правила](Selection-custom-rule.md)
- [Глобальные аналоги](Selection-global-analog.md)
- [Групповые замены](Selection-group-substitution.md)
- [Точные привязки](Selection-exact-fixation.md)
- [Производственный состав заказа](Selection-order-snapshot.md)
