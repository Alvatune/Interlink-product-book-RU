<!-- Generated from wiki/Selection-custom-rule.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Interlink должен поддерживать системные, общие и персональные правила: не только несколько встроенных вариантов, но и управляемое создание именованных правил. Персональное правило не сводится обязательно к запоминанию значений формы: ему могут быть разрешены собственные критерии в пределах, установленных предприятием.

## Как развивается каталог правил

Каталог правил должен развиваться независимо от полного выпуска модели там, где изменяются только разрешённые параметры и выражения. Новые предметные операции или изменение самого языка требуют отдельного контролируемого развития платформы.
...
Каталог общих и персональных правил, их редакции и единое исполнение входят в целевой порядок работы. Полный редактор, процедуры утверждения, анализ влияния и испытания на согласованном наборе правил ещё должны быть реализованы.

## Связанные документы

- [Жизненный цикл правил](Selection-rule-lifecycle.md)
- [Последняя допустимая версия](Selection-latest-version.md)
- [Резерв и отсутствие результата](Selection-no-match.md)
