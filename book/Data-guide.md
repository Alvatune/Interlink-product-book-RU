<!-- Generated from wiki/Data-guide.md. Edit the source, then run tools/Build-Book.ps1. -->
...
- [Объектный фундамент без привязки к отрасли](Object-foundation.md) и [примеры за пределами машиностроения](Multidomain-scenarios.md);
- [табличные данные](Tabular-data.md), [инженерные справочники](Reference-tables.md), [многомерные сетки](Multidimensional-tables.md) и [координатные карты](Coordinate-maps.md);
- [допустимые замены](Allowed-replacements.md) и [матрицы совместимости](Compatibility-matrices.md);
- [агенты и прослеживаемость решений](Agents-and-traceability.md).
...
- [Почему система типов является основой продукта](Data-type-system-vision.md)
- [Какие предметные конструкции поддерживает модель](Data-type-system-capabilities.md)
- [DSL как язык модели предприятия](Data-model-language.md)
- [Как типы материализуются в физическую базу данных](Data-database-materialization.md)
- [Расширяемость, настройка предприятия и развитие модели](Data-extensibility.md)

### Масштаб и переход с существующих систем

- [Производительность, высокая нагрузка и оркестрация агентов](Data-performance-and-agents.md)
- [Архитектурные решения системы данных](Data-architecture-decisions.md)
- [Стратегия миграции существующей базы данных](Data-migration-strategy.md)
- [Выполнение миграции и доказательство эквивалентности](Data-migration-execution.md)

### Рынок и развитие

- [Архитектурные подходы и компромиссы](Data-design-tradeoffs.md)
- [Развитие в сторону цифровых двойников](Data-digital-twins.md)
- [Сквозные машиностроительные примеры](Data-engineering-examples.md)
- [Состояние реализации, риски и критерии приёмки](Data-status-risks-acceptance.md)

### Как модель работает в руках людей

- [Как изменяется модель предприятия](Data-model-lifecycle.md)
- [Как модель превращается в работающую систему](Data-model-runtime.md)
- [Поиск, выборки и обход связей глазами пользователя](Data-search-and-queries.md)
- [Пакет выпуска модели, установка и обновление](Data-release-and-installation.md)
- [Настройки предприятия и разрешение конфликтов](Data-enterprise-settings.md)
- [Как продуктовые специалисты участвуют в переносе существующих данных](Data-migration-operating-model.md)

<a id="как-читать-пакет"></a>

## С чего начать чтение

Продуктовому специалисту рекомендуется начать со страниц [Почему система типов является основой продукта](Data-type-system-vision.md), [Как изменяется модель предприятия](Data-model-lifecycle.md), [Как модель превращается в работающую систему](Data-model-runtime.md) и [Как проходит перенос существующих данных](Data-migration-operating-model.md). Архитектору данных полезны документы о возможностях, физическом хранении, выпуске и настройках. Для обсуждения нагрузки и развития важны страницы об агентах, поиске и цифровых двойниках.
...
Индексируемые табличные наборы, координатные карты, отношения замен и совместимости, нейтральные формы записей и точные контексты агентов закреплены в целевой архитектуре. Наличие страниц об этих механизмах не означает, что они уже доступны в готовом пользовательском приложении. Актуальные границы собраны в [карте зрелости и приёмки](Data-status-risks-acceptance.md).
