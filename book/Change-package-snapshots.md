<!-- Generated from wiki/Change-package-snapshots.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Однако точность не повышает инженерную готовность: снимок опытного черновика не становится выпущенным документом. При восстановлении пользователь явно выбирает адресатов и объём переноса. Восстановление только в рабочие копии не меняет опубликованные состояния. Если нужен официальный выпуск, он проходит отдельную обычную подготовку и проверку. Подробнее — [итерации и восстановление](Selection-iterations.md).
...
Связанные документы: [проведение и восстановление](Change-package-commit.md), [точный состав заказа](Selection-order-snapshot.md), [публикация заказа](Order-exact-publication.md), [итерации и восстановление](Selection-iterations.md), [агенты и прослеживаемость](Agents-and-traceability.md).
