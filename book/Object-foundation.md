<!-- Generated from wiki/Object-foundation.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Физически эта гибкость не требует собирать все значения предприятия в одну безразмерную таблицу. Объявленные типы материализуются в типизированные таблицы и столбцы базы данных, а связи — в проверяемые ссылки и записи участия. Благодаря этому система может проверять допустимость данных и строить адресные запросы. Подробности пользовательских последствий — в [модели данных](Object-model-and-data.md) и [производительности](Performance-and-agents.md).
...
## Что это даёт специалисту предприятия
...
Продолжение: [межотраслевые сценарии](Multidomain-scenarios.md), [цифровые двойники](Digital-twins.md), [агенты и прослеживаемость](Agents-and-traceability.md), [текущее состояние и план](Current-state-and-roadmap.md).
