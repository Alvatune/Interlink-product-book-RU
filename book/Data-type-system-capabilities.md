<!-- Generated from wiki/Data-type-system-capabilities.md. Edit the source, then run tools/Build-Book.ps1. -->
...
## Какие задачи предприятия это решает

Целевая архитектура Interlink сочетает богатую предметную модель с явной физической структурой: известные типы и ограничения должны быть видимы системе управления базой данных, а приложение — использовать согласованный контракт. Это должно уменьшить число ошибок, обнаруживаемых лишь при поздней прикладной проверке. Результат предстоит подтвердить сквозным опытным образцом.
...
- [DSL как язык модели](Data-model-language.md)
- [Материализация в базе данных](Data-database-materialization.md)
