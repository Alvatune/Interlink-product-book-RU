...
Режим автоматического обновления — управляемая настройка. В совместимом сценарии при его включении взятие версии на редактирование, создание новой инженерной версии и создание нового объекта в составе обновляют назначения обычного контекста. При выключении режима эти события сами список не меняют.
