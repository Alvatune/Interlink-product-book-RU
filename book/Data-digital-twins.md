<!-- Generated from wiki/Data-digital-twins.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Обычная ссылка на «последние измерения» не подходит: завтра интервал сдвинется, калибровка изменится, а датчик заменят. Если нужные внешние данные позднее недоступны по правилам хранения, история должна указывать, какие исходные измерения недоступны и какие выводы из-за этого нельзя повторно проверить. Сохранённое описание решения не даёт права объявлять отсутствующие измерения сохранёнными.
...
2. На небольшом сквозном примере связать проектное основание, планируемый экземпляр, факт изготовления, установку, поздний акт и исправление. При этом обязательно проверить сценарии планирования и исполнения заказа.
...
- [Точные основания агентского решения](Agents-and-traceability.md)
- [Другие отрасли и нейтральные данные](Multidomain-scenarios.md)
