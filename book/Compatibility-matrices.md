...
**Статус: принятый целевой договор и план реализации.** Проверка простых отношений, обязательные сценарии и дальнейший сложный поиск решений имеют разные этапы. Наличие схемы хранения или текста правила ещё не доказывает, что его исполнитель уже готов.
