<!-- Generated from wiki/Multidomain-scenarios.md. Edit the source, then run tools/Build-Book.ps1. -->
...
В ближайшем плане такие небольшие проверки нужны до закрепления зависимых частей модели. Промышленные приложения логистики, одежды, пищевого производства, геометрические инструменты и расчётные решатели развиваются отдельно. При этом обязательные инженерные сценарии принимаются своим полным корпусом: их нельзя отложить вместе с расширенными отраслевыми возможностями.

Продолжение: [объектный фундамент](Object-foundation.md), [табличные формы](Tabular-data.md), [цифровые двойники](Digital-twins.md), [безопасные действия агентов](Agent-safe-actions.md), [план развития](Current-state-and-roadmap.md).
