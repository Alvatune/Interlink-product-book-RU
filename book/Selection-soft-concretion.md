...
В совместимом сценарии захват показанной версии применяется к исходной неконкретизированной связи. Уже имеющаяся конкретизация не исчезает от того, что её заслонил контекст или режим просмотра. Для замены существующего предпочтения нужна явная команда выбора, а не обход этого условия.
