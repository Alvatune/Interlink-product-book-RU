<!-- Generated from wiki/Order-lines-and-quantities.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Пользователь должен иметь возможность добавить в заказ несколько разных изделий без искусственного создания конструкторской сборки «Заказ». Корнем является реальный предметный объект заказа, а его позиции ведут к изделиям.
...
- [Комплектации и точное изделие](Order-configuration.md)
- [Точный состав передачи](Order-exact-publication.md)
- [Экземпляры и партии](Order-units-lots-as-built.md)
- [Независимые контексты выбора](Selection-contexts.md)
