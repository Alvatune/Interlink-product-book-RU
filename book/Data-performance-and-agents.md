<!-- Generated from wiki/Data-performance-and-agents.md. Edit the source, then run tools/Build-Book.ps1. -->
...
## За счёт чего планируется поддерживать высокую нагрузку

Интенсивный поиск по общим таблицам значений и согласование нескольких параллельных представлений данных могут увеличивать стоимость запросов и записи. Interlink предусматривает типизированное хранение известных предметных данных, управляемые индексы и согласованный способ доступа. Выбор должен проверяться на реальных запросах, а не оцениваться только по внешнему виду схемы.
...
Это обоснование выбранной архитектуры, а не готовый протокол испытаний. Целевые показатели подтверждаются на закреплённых сценариях, объёмах, правилах доступа и оборудовании.
...
Один из ориентиров испытаний — сравнение типовых структурных запросов с вручную оптимизированным эталоном. Зафиксированный в техническом плане порог 1,5 раза является поводом пересмотреть решение, а не обещанной пользователю задержкой и не результатом уже выполненного сравнения.
...
- промышленная приёмка требует согласованного профиля нагрузки предприятия.
...
7. Проверка требований использует одинаковые данные и явно фиксирует конфигурацию продукта.
...
- [Проверка требований](Data-architecture-decisions.md)
- [Цифровые двойники](Data-digital-twins.md)
- [Агенты и прослеживаемость](Agents-and-traceability.md)
- [Безопасные действия агента](Agent-safe-actions.md)
