<!-- Generated from wiki/How-to-participate.md. Edit the source, then run tools/Build-Book.ps1. -->

# Как присоединиться к диалогу

<a id="нам-нужен-не-отзыв-нравится--не-нравится"></a>

## С чего начать замечание

Можно начать с простого вопроса или указания на непонятный абзац. Полное описание процесса для первого обращения не требуется. Если есть возможность, добавьте конкретную задачу, ожидаемый результат и пример: это поможет понять причину замечания и проверить решение.
...
4. Какой результат требуется пользователю?
...
Для агентского сценария важно добавить, какие документы и данные можно показывать и удерживать, кто вправе разрешить действие и как установить результат при потере ответа. Начальные вопросы есть в [Новом разделе таблиц и совместимости](Questions-tables-and-compatibility.md) и [Вопросах об агентах](Questions-agents.md).

## Куда направить замечание сейчас

Используйте одну из подготовленных форм: [описать обязательный сценарий](https://github.com/Alvatune/Interlink-product-book-RU/issues/new?template=user-scenario.yml) или [оставить замечание и предложение](https://github.com/Alvatune/Interlink-product-book-RU/issues/new?template=product-feedback.yml).

Подходящие темы:

- ошибка или неоднозначность в описании сценария;
...
- разобрать свой рабочий сценарий и возможности Interlink;
