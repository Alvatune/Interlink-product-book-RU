<!-- Generated from wiki/Change-package-examples.md. Edit the source, then run tools/Build-Book.ps1. -->
...
Различие полного набора и разреженной карты подробнее разобрано в [обзоре табличных данных](Tabular-data.md), [многомерных таблицах](Multidimensional-tables.md) и [координатных картах](Coordinate-maps.md).
...
Примеры фиксируют целевой продуктовый результат и основу приёмки: независимые рабочие области, управляемые публикации, одиночные и комплектные замены, индексируемые наборы и агентские действия. Для каждого примера нужно проверить обычный ход работы, ограничения полномочий, конкурирующее изменение и восстановление после ошибки.
...
Связанные документы: [жизненный цикл](Change-package-lifecycle.md), [виды изменений](Change-package-variants.md), [рабочие данные](Change-package-visibility.md), [допустимые замены](Allowed-replacements.md), [матрицы совместимости](Compatibility-matrices.md), [агенты и прослеживаемость](Agents-and-traceability.md), [приёмка](Change-package-status.md).
