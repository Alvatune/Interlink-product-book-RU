...
Связанные документы: [[стратегия миграции|Data-migration-strategy]], [[выполнение и доказательство|Data-migration-execution]], [[жизненный цикл модели|Data-model-lifecycle]], [[выпуск и установка|Data-release-and-installation]], [[открытые вопросы миграции|Questions-migration]].

Новые области приёмки: [[табличные справочники|Reference-tables]], [[допустимые замены|Allowed-replacements]], [[матрицы совместимости|Compatibility-matrices]], [[действия агентов и прослеживаемость|Agents-and-traceability]].
