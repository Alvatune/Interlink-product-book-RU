...
Связанные документы: [[язык модели|Data-model-language]], [[материализация|Data-database-materialization]], [[расширяемость|Data-extensibility]], [[установка и работа системы|Data-model-runtime]], [[миграция существующих данных|Data-migration-strategy]], [[предметно-независимый фундамент|Object-foundation]], [[табличные данные|Tabular-data]], [[действия агентов и прослеживаемость|Agents-and-traceability]].
