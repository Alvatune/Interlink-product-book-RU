...
Далее: [[жёсткая привязка|Selection-exact-fixation]], [[контексты|Selection-contexts]], [[временная проработка|Selection-temporary-preference]], [[итерации|Selection-iterations]], [[допустимые замены|Allowed-replacements]], [[путеводитель|Version-selection-guide]].
