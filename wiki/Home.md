...
Для первого знакомства откройте [[Маршрут знакомства|Start-here]], затем [[Как работает система|How-system-works]]. Короткие ответы собраны в [[Частых вопросах|FAQ]]. Для предметного обсуждения сопоставьте [[Пользовательские сценарии и решения|User-scenarios-and-solutions]] с [[Открытыми вопросами|Open-questions]].

Для проверки полноты откройте [[карту обязательных сценариев|Scenario-coverage]].
