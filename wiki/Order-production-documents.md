...
Масса или длина провода может определяться по индексируемому справочнику. Паспорт отчёта сохраняет использованную редакцию строки, единицы и округление. Наличие в файле готового итога не заменяет происхождение расчёта. Подробнее — [[справочные таблицы|Reference-tables]].
