...
Однозначность назначения объекту в группе не запрещает разные версии одной детали на отдельных позициях. [[Позиционная мягкая конкретизация|Selection-soft-concretion]] имеет другую область; её взаимодействие с общим назначением определяется явным профилем.
...
Далее: [[мягкая конкретизация|Selection-soft-concretion]], [[пакет изменения|Selection-change-package]], [[последовательное проведение|Selection-sequential-changes]], [[итерации|Selection-iterations]], [[общий путеводитель|Version-selection-guide]].
