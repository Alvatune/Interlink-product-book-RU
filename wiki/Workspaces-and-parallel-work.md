...
Это позволяет отделить три решения: начать или продолжить редактирование; выбрать условия совместного просмотра; выпустить определённый результат. Для третьего решения используется [[пакет изменения|Change-package-concept]], для второго — [[контекст подбора|Selection-contexts]].
...
Связанные страницы: [[пакет изменения|Change-package-guide]], [[рабочая видимость|Change-package-visibility]], [[контексты|Selection-contexts]], [[итерации|Selection-iterations]], [[мягкая конкретизация|Selection-soft-concretion]], [[агенты и прослеживаемость|Agents-and-traceability]].
