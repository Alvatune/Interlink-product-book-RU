...
|---|---|---|
| [Справочник существующих строк](Reference-tables) | Какие типоразмеры, нормы или предложения действительно заданы? | Такой строки в выбранном источнике нет; все сочетания значений колонок не подразумеваются |
| [Полная многомерная таблица](Multidimensional-tables) | Есть ли результат для каждой точки объявленной конечной программы? | В рабочей таблице — незавершённость; в опубликованной полной сетке — нарушение заявленной полноты |
| [Карта сопоставлений](Coordinate-maps) | Какой результат задан для этого сочетания признаков? | Сопоставление не задано; запрет или разрешение требуют дополнительного правила |
...
- [[Допустимые замены|Allowed-replacements]] объясняют, **что разрешено поставить вместо исходного объекта или целого комплекта**, в какой области и на каком основании.
- [[Матрицы совместимости|Compatibility-matrices]] объясняют, **могут ли все выбранные участники работать вместе**, включая ограничения конкретных версий, материалов, режима и общих ресурсов.

Например, справочник может вернуть три уплотнения, подходящих по размерам. Перечень заменителей может разрешать два из них для данного насоса. Проверка среды и температуры может оставить одно. Подбор версии этого уплотнения остаётся обычным [[подбором версий|Version-selection-guide]], а фактическая установка — отдельным [[событием эксплуатации|Order-units-lots-as-built]]. Эти этапы нельзя заменить одним зелёным цветом клетки.
...
Стартовать можно с ближайшей задачи: [[справочная таблица|Reference-tables]], [[полная многомерная сетка|Multidimensional-tables]] или [[разреженная карта|Coordinate-maps]]. Общая модель объясняется в [[путеводителе по данным|Data-guide]], состояние работ — в [[дорожной карте|Current-state-and-roadmap]].
