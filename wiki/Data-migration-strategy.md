...
- [[Предметный язык модели и устойчивые определения|Data-model-language]]
- [[Табличные справочники|Reference-tables]]
- [[Допустимые замены и комплекты|Allowed-replacements]]
