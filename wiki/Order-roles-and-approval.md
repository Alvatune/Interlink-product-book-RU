...
Разрешение [[альтернативного комплекта|Allowed-replacements]] подтверждает его пригодность в указанной области. Заказ отдельно выбирает этот комплект для своих позиций. Перед выдачей проверяются полные участники, количества, сохраняемые узлы и [[совместимость выбранного содержания|Compatibility-matrices]]. Подпись не превращает недостающую обязательную деталь в необязательную и не отменяет неотменяемое требование безопасности.

Технолог, например, может принять покрытие из [[справочника|Reference-tables]] для стального корпуса и морской среды. Для алюминиевого корпуса тот же выбор требует своего основания. Проверка сохраняет конкретную редакцию нормы, условия и использованные испытания. Изменение справочника не переписывает старое решение, но его отзыв может потребовать остановить новую передачу и проанализировать затронутые заказы.
