...
Смежные темы: [[выбор формы табличных данных|Tabular-data]], [[обычные справочники|Reference-tables]], [[разреженные карты|Coordinate-maps]], [[правила совместимости|Compatibility-matrices]].
