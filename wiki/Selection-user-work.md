...
Рабочая область, контекст и пакет не совпадают. Контекст отвечает за назначения, область — за незавершённое содержание, пакет — за совместное проведение. Их различия подробно описаны в [[контекстах и группах|Selection-contexts]].
...
Далее: [[сквозные сценарии|Selection-end-to-end]], [[правила и их редакции|Selection-rule-lifecycle]], [[пакет изменения|Change-package-guide]], [[контексты|Selection-contexts]], [[мягкая конкретизация|Selection-soft-concretion]], [[снимок заказа|Selection-order-snapshot]].
