...
Рабочая область отвечает за незавершённую работу. [[Контекст подбора|Selection-contexts]] отвечает за сохранённые выборы версий и условия их использования. Пакет изменения отвечает за совместную публикацию согласованного набора правок. Контекст заказа может жить дольше одного пакета, а пробный расчёт не обязан создавать пакет только ради просмотра.
